...
function customizer_library_sabino_options() {
    ...
    $options['sabino-unote-footer'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Offers an advanced custom footer layout - Set custom columns and customize the column widths<br />- Remove Footer bottom bar', 'sabino' )
    );
    ...
    $sections[] = array(
        'id' => $section,
        'title' => __( 'Plugin Support', 'sabino' ),
        'priority' => '120',
