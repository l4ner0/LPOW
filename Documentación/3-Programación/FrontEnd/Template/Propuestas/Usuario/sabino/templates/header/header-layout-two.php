 ...
 */
global $woocommerce; ?>
<header id="masthead" class="site-header site-header-layout-two <?php echo ( get_theme_mod( 'sabino-header-centered-layout' ) ) ? sanitize_html_class( 'site-header-centered-layout' ) : ''; ?>">
